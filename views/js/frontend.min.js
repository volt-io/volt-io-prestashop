...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   radioPayments: function() { return /* binding */ radioPayments; }\n/* harmony export */ });\n/* harmony import */ var _partials_payment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_partials/payment */ \"./frontend/js/_partials/payment.ts\");\n/* harmony import */ var _partials_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_partials/helpers */ \"./frontend/js/_partials/helpers.ts\");\n/* harmony import */ var _partials_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_partials/modal */ \"./frontend/js/_partials/modal.ts\");\n/* harmony import */ var _partials_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_partials/icons */ \"./frontend/js/_partials/icons.ts\");\n\n\n\n\nlet moduleName = document.querySelector('[data-module-name=\"volt\"]');\n(0,_partials_icons__WEBPACK_IMPORTED_MODULE_3__.createIconInfo)(moduleName);\n(0,_partials_modal__WEBPACK_IMPORTED_MODULE_2__.ready)(_partials_modal__WEBPACK_IMPORTED_MODULE_2__.openModal);\n(0,_partials_modal__WEBPACK_IMPORTED_MODULE_2__.ready)(_partials_modal__WEBPACK_IMPORTED_MODULE_2__.closeModal);\n(0,_partials_icons__WEBPACK_IMPORTED_MODULE_3__.createPartnerIcons)(moduleName);\n(0,_partials_icons__WEBPACK_IMPORTED_MODULE_3__.showPartnerIcons)(moduleName);\naddEventListener(\"resize\", (event) => {\n  (0,_partials_icons__WEBPACK_IMPORTED_MODULE_3__.showPartnerIcons)(moduleName);\n});\nfunction radioPayments() {\n  if (isVoltModuleChecked()) {\n    setTimeout(() => {\n      paymentOption(document.querySelector('[data-module-name=\"volt\"]'));\n      const additionalInformation = document.querySelector(\"#payment-option-1-additional-information\");\n      if (additionalInformation) {\n        additionalInformation.style.display = \"block\";\n      }\n    }, 250);\n  }\n  let paymentInput = document.querySelector('input[data-module-name=\"volt\"]');\n  if (paymentInput) {\n    paymentInput.addEventListener(\"click\", (e) => {\n      const target = e.target;\n      console.log(\"click payment element\");\n      if (target.checked === true) {\n        paymentOption(paymentInput);\n      }\n    });\n  }\n}\nfunction isVoltModuleChecked() {\n  const voltElement = document.querySelector('[data-module-name=\"volt\"]');\n  if (voltElement && voltElement instanceof HTMLInputElement) {\n    return voltElement.checked;\n  } else {\n    return false;\n  }\n}\nfunction paymentOption(formRadioId) {\n  if (formRadioId) {\n    (0,_partials_payment__WEBPACK_IMPORTED_MODULE_0__.checkPayment)();\n  }\n}\nresetForm(getVoltPaymentElement());\nradioPayments();\nfunction resetForm(arr) {\n  arr.forEach((item, i) => {\n    if (0 === i) {\n      const form = document.querySelector(\"#pay-with-payment-option-\" + (0,_partials_helpers__WEBPACK_IMPORTED_MODULE_1__.getIdElement)(item) + \"-form form\");\n      form.remove();\n    }\n  });\n}\nfunction getVoltPaymentElement() {\n  const allElements = document.querySelectorAll(\".js-additional-information.additional-information\");\n  const array = Array.from(allElements);\n  const classElm = \"volt-payment\";\n  return array.filter((element) => Array.from(element.children).some((item) => item.classList.contains(classElm)));\n}\n\n\n//# sourceURL=webpack://volt/./frontend/js/front.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://volt/./frontend/scss/front.scss?");
...
/******/ 	__webpack_require__("./frontend/js/front.ts");
/******/ 	var __webpack_exports__ = __webpack_require__("./frontend/scss/front.scss");
/******/ 	
/******/ })()
;